...
public class XiangMuFragment extends Fragment implements ShenbaoProjectsView {
    ...
    SmartRefreshLayout refreshXiangmu;
    ...
    private void refreshAndLoadMore() {
        refreshXiangmu.setOnRefreshListener(new OnRefreshListener() {
            @Override
        ...
        refreshXiangmu.setOnLoadMoreListener(new OnLoadMoreListener() {
            @Override
        ...
        refreshXiangmu.setRefreshHeader(new ClassicsHeader(getActivity()));
        refreshXiangmu.setHeaderHeight(50);
