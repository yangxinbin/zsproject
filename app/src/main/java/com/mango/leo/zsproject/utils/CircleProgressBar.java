...
public class CircleProgressBar extends View{
    ...
    public CircleProgressBar(Context context, AttributeSet attrs,
        ...
        roundColor = typedArray.getColor(R.styleable.CircleProgressBar_roundColor, Color.GREEN);
        roundProgressColor = typedArray.getColor(R.styleable.CircleProgressBar_roundProgressColor, Color.RED);
        innerRoundColor = typedArray.getColor(R.styleable.CircleProgressBar_innerRoundColor, 0x00000000);
        roundWidth = typedArray.getDimension(R.styleable.CircleProgressBar_roundWidth, 5);
        ...
        style = typedArray.getInt(R.styleable.CircleProgressBar_style, STROKE);
        isDisplayText  =typedArray.getBoolean(R.styleable.CircleProgressBar_textIsDisplayable, true);
        typedArray.recycle();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(oval, 0, 360 * 100 / max, false, paint);
